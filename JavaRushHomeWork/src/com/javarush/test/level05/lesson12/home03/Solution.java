...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        Mouse cousineOfJerry = new Mouse("Brother",6,2);
        Cat Tom = new Cat("Tom",40,20);
        Cat streetCat = new Cat("UnnamedCat", 41,21);
        Dog buldog = new Dog("Buldog", 56,15);
        Dog puppy = new Dog("Puppy", 30,10);
    }
